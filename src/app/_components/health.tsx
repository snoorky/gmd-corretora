      ...
      <div className="relative flex flex-col xl:flex-row justify-between items-center text-center text-white">
        <div className="flex flex-col items-center justify-center xl:items-start xl:text-left xl:w-[50%]">
          ...
          <p className="my-4 md:my-8">
            Intermediamos a contratação dos principais planos de saúde disponíveis no mercado
            nacional, sempre com foco na sua real necessidade. Comparamos operadoras, coberturas e
            condições para oferecer o melhor custo benefício, seja para sua família ou para a sua
            empresa.
          </p>
        ...
        <div className="bg-white/70 space-y-4 rounded-2xl text-dark mt-6 md:mt-12 xl:mt-0 p-4 md:p-8 xl:w-[40%]">
          <h3>Preencha seus dados e receba a proposta ideal para sua empresa ou família</h3>
          <Forms label="Saude" />
        </div>
      </div>
    </section>
