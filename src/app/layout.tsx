...
import ScrollToHashOffset from "./_components/scroll";
...
const whatsAppMessage =
	"Olá!+Gostaria+de+falar+com+um+consultor+sobre+seguro,+plano+de+saúde+ou+consórcio+sob+medida";
		...
		<html lang="pt-BR" className={myFont.className}>
			...
			<body className="antialiased">
				...
				<Link
					...
					target="_blank"
					href={`https://api.whatsapp.com/send?phone=5515981377486&text=${whatsAppMessage}`}
				>
					<Image
						width={60}
						height={60}
